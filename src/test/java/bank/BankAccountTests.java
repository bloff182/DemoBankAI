...
public class BankAccountTests {
    ...
    void testDeposit_PositiveAmount() {
        ...
        // THEN - The actual balance should equal the expected balance (initial balance + deposit)
    ...
    void testWithdraw_PositiveAmount() {
        ...
        // THEN - The actual balance should equal the expected balance (initial balance - withdraw)
