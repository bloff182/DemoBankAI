...
public class BankTransferImplTests {
    ...
    @Test
    public void transfer_WhenEnoughBalance_ThenTransferSuccessful() {
        // Given
    ...
    @Test
    public void transfer_WhenNotEnoughBalance_ThenThrowException() {
        // Given
    ...
    @Test
    public void openAccount_WithPositiveBalance_ThenAccountCreated() {
        // Given
        BankTransferImpl bankTransfer = new BankTransferImpl();
